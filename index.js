...
client.once('ready', async () => {
  ...
  client.user.setActivity(' Quantum Corporation ', { type: ActivityType.Listening });
...
client.on('messageCreate', async (message) => {
  ...
  if (!args) return message.reply('Please provide a song name or URL!');
  ...
  const res = await manager.search(args, message.author);
